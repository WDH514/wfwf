package com.example.qiaoxg.selectphotodemo.utils;
...
import com.example.qiaoxg.selectphotodemo.model.Filter_Effect_Info;
...
public class FilterUtils {
	...
	public static ArrayList<Filter_Effect_Info> getEffectList(){
		...
		effect_list.add(new Filter_Effect_Info("原图", R.drawable.camerasdk_filter_normal,FilterType.PIXELATION));
		effect_list.add(new Filter_Effect_Info("新鲜", R.drawable.camerasdk_filter_rise,FilterType.I_NASHVILLE));
		effect_list.add(new Filter_Effect_Info("浪漫", R.drawable.camerasdk_filter_in1977,FilterType.I_1977));
		effect_list.add(new Filter_Effect_Info("梨白", R.drawable.camerasdk_filter_amaro,FilterType.I_AMARO));
		effect_list.add(new Filter_Effect_Info("西柚", R.drawable.camerasdk_filter_brannan,FilterType.I_BRANNAN));
		effect_list.add(new Filter_Effect_Info("清新", R.drawable.camerasdk_filter_sierra,FilterType.I_SIERRA));
		effect_list.add(new Filter_Effect_Info("阳光", R.drawable.camerasdk_filter_walden,FilterType.I_WALDEN));
		effect_list.add(new Filter_Effect_Info("小森林", R.drawable.camerasdk_filter_early_bird,FilterType.I_EARLYBIRD));
		effect_list.add(new Filter_Effect_Info("优格", R.drawable.camerasdk_filter_hefe,FilterType.I_HEFE));
		effect_list.add(new Filter_Effect_Info("和风", R.drawable.camerasdk_filter_valencia,FilterType.I_VALENCIA));
		//effect_list.add(new Filter_Effect_Info("胶片", R.drawable.camerasdk_filter_hudson,FilterType.I_HUDSON));

		effect_list.add(new Filter_Effect_Info("心境", R.drawable.camerasdk_filter_lomo,FilterType.I_LOMO));
		effect_list.add(new Filter_Effect_Info("回忆", R.drawable.camerasdk_filter_lord_kelvin,FilterType.I_LORDKELVIN));
		effect_list.add(new Filter_Effect_Info("斑斓", R.drawable.camerasdk_filter_nashville,FilterType.CONTRAST));


		effect_list.add(new Filter_Effect_Info("电影", R.drawable.camerasdk_filter_sutro,FilterType.I_SUTRO));
		effect_list.add(new Filter_Effect_Info("现代", R.drawable.camerasdk_filter_toaster,FilterType.I_TOASTER));
